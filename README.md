...
4. What you still need to do once, in go to wp-config.php and add the following line (use https://api.wordpress.org/secret-key/1.1/salt/ to generate a random string)
